...
public class IndexingServer {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("+++++++++++++++INDEXING SERVER INITIATED+++++++++++++++");
        int peerId = 1;
            ...
            try {
                ...
                while(true) {
                    ...
                    if (requestType.equalsIgnoreCase("REGISTER")) {
                    	...
                    	final ArrayList<String> indexedLocations = register(clientNumber, clientIp, (ArrayList<String>) peerRequest.getRequestData(), out);
                    	response = new Response();
                    	response.setResponseCode(200);
